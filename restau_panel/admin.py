...
from restau_panel.models import restaurantMenuCategory,restaurantMenuItems,restaurantTable,restaurantOrder,restaurantOrderItem,restaurantOrderReview
...
admin.site.register(restaurantOrderReview)