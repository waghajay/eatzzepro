...
urlpatterns = [
    ...
    path('delete-menu-item/<int:item_id>/', delete_menu_item, name='delete-menu-item'),
    path('toggle-menu-item-availability/<int:item_id>/',toggle_menu_item_availability,name='toggle-menu-item-availability'),
